...
plt.xticks([])
plt.savefig(f'v3_copy/device_2_count.png', bbox_inches='tight', dpi=300)
plt.show()
...
for p in plt.gca().patches:
    plt.text(p.get_x() + p.get_width()/2, p.get_height() * 1.005, '{}'.format(p.get_height()), ha='center', fontsize=11, color='black')
plt.xticks([])
plt.savefig(f'v3_copy/device_3_combination.png', bbox_inches='tight', dpi=300)
plt.show()
...
for p in plt.gca().patches:
    plt.text(p.get_x() + p.get_width()/2, p.get_height() * 1.005, '{}'.format(p.get_height()), ha='center', fontsize=11, color='black')
plt.xticks([])
plt.savefig(f'v3_copy/device_3_count.png', bbox_inches='tight', dpi=300)
plt.show()
...
plt.ylabel('Count')
plt.legend()
plt.savefig(f'v3_copy/hiking_duration_3_5_devices.png', bbox_inches='tight', dpi=300)
plt.show()
print('done')
...
plt.savefig(f'v3_copy/hiking_duration_by_number_of_devices.png', bbox_inches='tight', dpi=300)
plt.show()
...
plt.savefig(f'v3_copy/device_counts.png', bbox_inches='tight', dpi=300)
plt.show()
...
plt.xticks(rotation=0, ha='center')
plt.tight_layout()
plt.savefig(f'v3_copy/device_counts_palette_tab10.png', bbox_inches='tight', dpi=300)
plt.show()
...
plt.xticks(rotation=0, ha='center')
plt.tight_layout()
plt.savefig(f'v3_copy/device_counts_seaborn.png', bbox_inches='tight', dpi=300)
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig(f'v3_copy/gender_device_counts.png', bbox_inches='tight', dpi=300)
plt.show()
...
plt.savefig(f'v3_copy/2_devices_combined.png', bbox_inches='tight', dpi=300)
plt.show()
###----------------------- Count -----------------------
...
# plt.savefig(f'v3_copy/2_devices_combined_count.png', bbox_inches='tight', dpi=300)
# plt.show()
# print('done\n')
...
plt.xticks(rotation=0, ha='center')
plt.savefig(f'v3_copy/number_of_devices', bbox_inches='tight', dpi=300)
plt.show()
print('done')
...
plt.savefig(f'v3_copy/heatmap_number_of_devices.png', bbox_inches='tight', dpi=300)
plt.show()
